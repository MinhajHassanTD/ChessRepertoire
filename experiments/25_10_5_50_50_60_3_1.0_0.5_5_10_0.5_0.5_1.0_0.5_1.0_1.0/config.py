...
REPERTOIRE_REINIT_FRACTION     = 0.1
...
MAIN_SEEDS    = list(range(1000, 1003))   # 15 seeds → 15 independent runs per method
...
BASELINE_SEEDS   = list(range(1000, 1003))
...
CLOSURE_ABLATION_SEEDS   = list(range(1000, 1003))   # same 15 seeds as main
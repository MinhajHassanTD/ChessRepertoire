...
REPERTOIRE_REINIT_FRACTION     = 0.25
...
MAIN_SEEDS    = list(range(1000, 1002))   # 15 seeds → 15 independent runs per method
...
BASELINE_SEEDS   = list(range(1000, 1002))
...
CLOSURE_ABLATION_SEEDS   = list(range(1000, 1002))   # same 15 seeds as main